...
-- AddForeignKey
ALTER TABLE "common"."branch" ADD CONSTRAINT "branch_manager_id_fkey" FOREIGN KEY ("manager_id") REFERENCES "common"."manager"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "common"."section" ADD CONSTRAINT "section_manager_id_fkey" FOREIGN KEY ("manager_id") REFERENCES "common"."manager"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "common"."business" ADD CONSTRAINT "business_manager_id_fkey" FOREIGN KEY ("manager_id") REFERENCES "common"."manager"("id") ON DELETE SET NULL ON UPDATE CASCADE;
