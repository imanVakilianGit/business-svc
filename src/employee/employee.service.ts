...
import { FAILED_EMPLOYEE_ALREADY_EXISTS, FAILED_EMPLOYEE_NOT_FOUND, FAILED_USER_NOT_FOUND } from './response/error/failed-public.result';
...
import { FAILED_SECTION_NOT_FOUND } from '../section/response/error/faied-public.result';
import { FAILED_BRANCH_NOT_FOUND } from '../branch/response/error/faied-public.result';
...
export class EmployeeService {
    ...
    async create(dto: CreateEmployeeDto | (CreateEmployeeDto & { employeeCode: string })) {
        try {
            ...
            await this._checkExistenceEmployeeWithActivationStatus(dto.userId, true, 'no');
    ...
    // =============================================================================================================
    private async _checkExistenceEmployeeWithActivationStatus(userId: number, isActive: boolean, shouldExists: 'yes' | 'no') {
